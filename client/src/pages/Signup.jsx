  ...
  return (
    <div className="mx-auto max-w-sm p-4 bg-gray-800 min-h-screen">
      ...
      <form
        ...
        className="bg-gray-800 p-6 rounded-lg border border-gray-100"
      >
        <h2 className="font-inter text-center text-6xl font-bold mb-6 text-gray-100">Signup</h2>
        ...
        <br />
        <h4 className="text-xl font-bold mb-2 text-gray-100">Already a User?</h4>
        <button
          className="rounded-2xl mt-2 w-full px-3 py-2 bg-blue-500 hover:bg-blue-600 text-white transition"
          type="button"
          onClick={() => navigate("/")}
